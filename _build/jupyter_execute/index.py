...
for det in dets:
    ...
    if make_plots:
        ...
        # -- Plot the result
        utils.plot_all(time, timemax, SNR, pcolor, det, eventname, plottype, tevent, strain_whitenbp, template_match, template_fft, datafreq, d_eff, freqs, data_psd, fs, 'figures/')
